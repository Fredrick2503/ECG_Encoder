...
# =====================================================================
# Model 1: Attention-Based MLP Autoencoder
# =====================================================================
...
class AttentionMLPAutoencoder(nn.Module):
    def __init__(self, input_dim: int, latent_dim: int = 32, dropout: float = 0.3, num_heads: int = 4, hidden_units: int = 128, num_classes: int = 5):
        ...
        # Self-Attention (sequence length = 1, embed_dim = hidden_units)
    ...
    def encode(self, x):
        ...
        x_seq = x.unsqueeze(0)  # Shape: [1, Batch, HiddenUnits]
        attn_out, _ = self.attention(x_seq, x_seq, x_seq)
        x = attn_out.squeeze(0)  # Shape: [Batch, HiddenUnits]
...
# =====================================================================
# Model 2: Beta-VAE (Variational Autoencoder)
# =====================================================================
...
# =====================================================================
# Model 3: FT-Transformer Autoencoder
# =====================================================================
...
class FTTransformerAutoencoder(nn.Module):
    ...
    def encode(self, x):
        ...
        x_seq = torch.cat([cls_tokens, tokens], dim=1)  # [Batch, NumFeatures + 1, d_model]
        
        # Pass through Transformer blocks
        trans_out = self.transformer(x_seq)  # [Batch, NumFeatures + 1, d_model]
        
        # Extract CLS output
        cls_representation = trans_out[:, 0, :]  # [Batch, d_model]
