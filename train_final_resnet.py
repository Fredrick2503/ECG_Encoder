...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Final ECG ResNet Training on Full Dataset")
    ...
    parser.add_argument("--experiment_name", type=str, default="ECG_ResNet_Final", help="MLflow experiment name")
    ...
    # ResNet parameters
    parser.add_argument("--base_filters", type=int, default=64, help="ResNet base filters")
